...
const CalendarComponent = ({ selectedDate, onDateChange }) => {
  ...
  This modification ensures that currentDate is always a string in the format "YYYY-MM-DD". The calendar component should now work without any errors. If you continue to experience issues, please let me know.
