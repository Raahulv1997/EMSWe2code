      ...
      <View style={styles.container}>
        ...
        <View style={styles.infoContainer}>
          <Text style={styles.name}>
            ...
            <br />
            {Attendance.status === "P" ? (
              <Text style={{ color: "green", fontSize: 20 }}> present</Text>
            ) : Attendance.status === "L" ? (
              <Text style={{ color: "yellow", fontSize: 20 }}> Late</Text>
            ) : Attendance.status === "A" ||
              ...
              <Text style={{ color: "blue", fontSize: 20 }}> Half Day</Text>
            ) : Attendance.status === "WH" ? (
              <Text style={{ color: "green", fontSize: 20 }}> WFH</Text>
            ) : null}
          </Text>
