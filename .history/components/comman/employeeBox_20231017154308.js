      ...
      <View style={styles.container}>
        ...
        <View style={styles.infoContainer}>
          <Text style={styles.name}>
            ...
            <br />
            {Attendance.status === "P" ? (
              <Text style={{ color: "green", fontSize: 15 }}> present</Text>
            ) : Attendance.status === "L" ? (
              <Text style={{ color: "yellow", fontSize: 15 }}> Late</Text>
            ) : Attendance.status === "A" ||
              ...
              <Text style={{ color: "blue", fontSize: 15 }}> Half Day</Text>
            ) : Attendance.status === "WH" ? (
              <Text style={{ color: "green", fontSize: 15 }}> WFH</Text>
            ) : null}
          </Text>
